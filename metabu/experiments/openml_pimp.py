...
class ConditionalImputer(BaseEstimator, TransformerMixin):
    """
    Imputer que maneja de manera distinta columnas nominales y numéricas,
    y permite un fill_empty para columnas que solo tienen NaN.
    """
...
# class ConditionalImputer(BaseEstimator, TransformerMixn):
