...
def get_metabu_representations(cfg, basic_reprs, target_reprs, list_ids, train_ids, test_ids):
    ...
    # print(f"El shape es de :{metabu_reprs.shape}")
    # print(f"metabu_reprs es :{metabu_reprs}")
...
def _auxiliar(cfg):
    ...
    return basic_reprs, target_reprs, list_ids
...
def run_task1(cfg):
    ...
    basic_reprs, target_reprs, list_ids = _auxiliar(cfg)
...
def return_neighbors(cfg):

    basic_reprs, _ , list_ids = _auxiliar(cfg)
